...
@friedrich_pricing_special_customers.post("", response_model=None, tags=["jsonapi"])
async def new_friedrich_pricing_special_customer(token: Token) -> None:
    raise HTTPException(status_code=501)


@friedrich_pricing_special_customers.patch("", response_model=None, tags=["jsonapi"])
async def mod_friedrich_pricing_special_customer(token: Token) -> None:
    raise HTTPException(status_code=501)
