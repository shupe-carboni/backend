...
async def new_vendor_pricing_by_class(
    ...
    vendor_pricing_class_id = new_obj.data.relationships.vendor_pricing_classes.data[
        0
    ].id
...
async def mod_vendor_pricing_by_class(
    ...
    vendor_pricing_class_id = mod_data.data.relationships.vendor_pricing_classes.data[
        0
    ].id
